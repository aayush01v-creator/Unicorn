...
function buildNetwork(p: NetworkParams): NetworkConfig {
  ...
  const config: NetworkConfig = { 
    ...
    steps: p.steps, 
    dt: p.dt,
    membrane_time_constant: p.globalTau,
    refractory_period: p.globalRefractory
  };
...
export default function App() {
  ...
  return (
    <div className="app">
      ...
      <div className="main">
        {/* ── Config Panel ── */}
        <aside className={`config-panel ${showSidebar ? '' : 'hidden'}`}>
          <div className="config-scroll">
            ...
            <section className="config-section">
              ...
              <div className="config-section-body">
                ...
                <Slider label="Membrane τ" value={params.globalTau} min={1.0} max={50.0} step={1.0}
                  format={v => v.toFixed(1)}
                  onChange={v => set('globalTau', v)} />
                <Slider label="Refractory Period" value={params.globalRefractory} min={0.0} max={10.0} step={0.5}
                  format={v => v.toFixed(1)}
                  onChange={v => set('globalRefractory', v)} />
                ...
                <Slider label="Dropout Probability" value={params.globalDropout} min={0} max={0.5} step={0.01}
                  format={v => v.toFixed(2)}
